...
public class CommonTextDataCleanRule implements IDataCleanRule {
    ...
    private static List<DataCleanEntity> nomalSplit(Boolean isOrder, List<String> separatorKeys, String monitorData,List<DataCleanRuleEntity.DataMapping> resultColumns){
    ...
    private static List<DataCleanEntity> regexSplit(Boolean isOrder, List<String> separatorKeys,String monitorData,List<DataCleanRuleEntity.DataMapping> resultColumns){
        List<String> list = new ArrayList<>();
        if(separatorKeys != null && !separatorKeys.isEmpty()) {
            if (isOrder !=null && isOrder) {
                for(String key : separatorKeys){
    ...
    private static List<DataCleanEntity> converter(List<String> list,List<DataCleanRuleEntity.DataMapping> resultColumns){
