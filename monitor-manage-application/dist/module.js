        ...
        execute: function() {
            ...
            MonitorManageCtrl = (function (_super) {
                ...
                function MonitorManageCtrl($scope, $injector, $http, uiSegmentSrv) {
                    ...
                    //搜索所有授权的机器
                    this.searchAllAuthorizeMachines = function (serverHost, projectId) {
                        var _this = this;
                        this.allAuthorizeMachine = [];
                        this.$http({
                            ...
                            if (rsp.data.resultCode == 0) {
                                ...
                                //设置列表内容
                                _this.allAuthorizeMachine = rsp.data.data;
                            }
                            else {
                    ...
                    $scope.searchAllAuthorizeMachines = function (serverHost, projectId) {
                        ...
                        $http({
                            ...
                            if (rsp.data.resultCode == 0) {
                                ...
                                if (_this.ctrl.allAuthorizeMachine.length > 0) {
                                    $scope.formData.machineId = _this.ctrl.allAuthorizeMachine[0].id.toString();
                                    console.log('$scope.formData.machineId ' + $scope.formData.machineId);
                                }
                            }
                            else {
